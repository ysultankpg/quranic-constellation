...
function resize(){
  ...
  W=window.innerWidth-190; /* sidebar width */
  H=window.innerHeight-50-36; /* header + footer */
...
function drawFrame(){
  ...
  qc.stars.forEach((star,i)=>{
    ...
    if(vis){
      ...
      g.addColorStop(0,hexA(color,.2));g.addColorStop(1,hexA(color,0));
